...
WAIT_AFTER_JOIN = 15 # Wait at least this many seconds after the last join
MAXIMUM_WAITED = 5  # limit for amount of !wait's
STATS_RATE_LIMIT = 60
VOTES_RATE_LIMIT = 60
...
DAY_TIME_LIMIT_WARN = 300
DAY_TIME_LIMIT_CHANGE = 60
#JOIN_TIME_LIMIT = 3600
JOIN_TIME_LIMIT = 1800
